...
class Book(models.Model):
    ...
    """
    name = models.CharField(blank=True, max_length=128, verbose_name='Назва')
    ...
    year_publication = models.IntegerField(blank=True, default=2002, verbose_name='Рік видавництва')
    relized_at = models.DateTimeField(default=None, null=True, blank=True, verbose_name='Дата виходу')
    ...
    @staticmethod
    def create(name, description, count=10, authors=None, year_publication=None, relized_at=None):
        """
        param name: Describes name of the book
        type name: str max_length=128
        param description: Describes description of the book
        ...
        book.count = count
        book.year_publication = year_publication
        book.relized_at = relized_at
        book.save()
    ...
    def update(self, name=None, description=None, count=None,  year_publication=None, relized_at=None):
        """
        ...
        if relized_at is not None:
            self.relized_at = relized_at
