...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    """
    first_name = models.CharField(max_length=20, blank=True, verbose_name="Ім'я")
    last_name = models.CharField(max_length=20, blank=True, verbose_name='Прізвище')
    middle_name = models.CharField(max_length=20, blank=True, verbose_name='По батькові')
    email = models.CharField(max_length=100, unique=True, default=None, verbose_name='Електронна пошта')
    ...
    updated_at = models.DateTimeField(auto_now=datetime.datetime.now(), verbose_name='Змінено')
